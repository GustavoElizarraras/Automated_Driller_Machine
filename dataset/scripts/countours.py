import cv2
pcb1 = cv2.imread('dataset/hand_picked/13000186_original.jpg')
pcb1_bin = cv2.bitwise_not(cv2.imread('dataset/hand_picked/13000186_original.jpg', 0))
grosor=1
...
detected_circles = cv2.HoughCircles(pcb1_bin, 
               ...
               param2 = 13, minRadius = 8, maxRadius = 24)
